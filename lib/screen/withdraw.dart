                        ...
                        children: <Widget>[
                          ...
                          Container(
                            ...
                            child: DropdownButton<String>(
                              ...
                              hint: Text("Select Note",style:TextStyle(fontWeight: FontWeight.w600),),
                              isExpanded:true,
                              icon: Icon(Icons.arrow_downward),
                              iconSize:24,
                              elevation:16,
                              ...
                              items:<String>['Self Withdraw','Self Deposit','PoojaSet','School Uniform','Sabha Dress','Travel','Books','Stationary','Track shoot','Punishment'].map<DropdownMenuItem<String>>((String value) {
                                return DropdownMenuItem<String>(
                                  value:value,
                                  child:Text(value,style:TextStyle(fontWeight:FontWeight.w600),),
                                  );
                          ...
                          TextFormField(
                            ...
                            onEditingComplete: _node.nextFocus,
                              ...
                              validator: (value){
                              if(value.isEmpty){
                                return "Please Enter Your Student Pin";
                              }
                              else{
                                return null;
                              }
